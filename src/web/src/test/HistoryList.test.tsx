...
describe('HistoryList', () => {
  it('renders an empty state with no jobs', () => {
    render(<HistoryList jobs={[]} onSelect={() => {}} />)
  ...
  it('calls onSelect when a row is clicked', async () => {
    ...
    render(<HistoryList jobs={[makeJob({ id: 'j9' })]} onSelect={onSelect} />)
